package com.ysc.baiduapp.database;
...
import com.ysc.baiduapp.database.model.MySignalStrength;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // create notes table
        db.execSQL(MySignalStrength.CREATE_TABLE);
    }
    ...
    public long insertCell(String note) {
        ...
        // `id` and `timestamp` will be inserted automatically.
        // no need to add them
        values.put(MySignalStrength.COLUMN_NOTE, note);

        // insert row
        long id = db.insert(MySignalStrength.TABLE_NAME, null, values);
    ...
    public MySignalStrength getLastCell() {
        // Select All Query
        String selectQuery = "SELECT  * FROM " + MySignalStrength.TABLE_NAME + " ORDER BY " +
                MySignalStrength.COLUMN_TIMESTAMP + " DESC";
        MySignalStrength note = new MySignalStrength();
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);
        // looping through all rows and adding to list
        if (cursor.moveToFirst()) {
